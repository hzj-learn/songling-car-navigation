...
class LocalTrajectoryGenerator {
    ...
    ros::Publisher pub_base_trajectories;
    ros::Publisher pub_final_trajectories;
    ros::Publisher pub_closest_index;
    ...
    void getRolloutPaths_cb(const autoware_msgs::LaneArrayConstPtr& msg);
    void getDetectedObjects_cb(const autoware_msgs::DetectedObjectArrayConstPtr& msg);
    ...
    void set_detectObj(UtilityNS::DetectedObject& out_obj, const autoware_msgs::DetectedObjectArrayConstPtr& msg, const double& i);
