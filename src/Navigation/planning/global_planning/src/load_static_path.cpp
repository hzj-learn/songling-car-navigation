...
void load_path(std::string path_file, autoware_msgs::Lane& path)
{
    if (path_file == "None") {
    ...
    while (!std::feof(fp)) {
        autoware_msgs::Waypoint way_point;
        way_point.is_lane = 1;
...
void debug_show_result(autoware_msgs::Lane& path, ros::Publisher pub)
{
...
int main(int argc, char** argv)
{
    ...
    ros::Publisher pub_path = nh.advertise<autoware_msgs::Lane>("global_path", 1);
